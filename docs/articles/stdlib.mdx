...
The current coroutine will resume execution after all other ready coroutines had to opportunity to run.
...
Coroutine tokens are invalidated after they have been used to resume their coroutine once.
...
func createMutex() {
    ...
    return (
        lock: func() {
            ...
            // At this point, either the lock wasn't locked from the start
