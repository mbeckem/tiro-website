...
- [Input and output](#input-and-output)
  ...
  - [func debug_repr](#func-debug_repr)
...
```
func debug_repr(value: Value): String;
```
...
- Call an asynchronous function.
  ...
  They can be implemented in native code or by using the the [yield_coroutine()](#func-yield_coroutine) function (like the function `lock()` in the [mutex example](#mutex-example)).
...
- Call [yield_coroutine()](#func-yield_coroutine).
