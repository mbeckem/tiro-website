...
The following example performs a _system wide_ installation of tiro and assumes root privileges.  
...
<span className="caption">Example: hello.c</span>
...
More complex examples are maintained in the [Github repository](https://github.com/mbeckem/tiro/tree/master/examples).

The [C++ embedding example](https://github.com/mbeckem/tiro/tree/master/examples/embed_cpp) demonstrates how to use the C++ API in your application.
